...
ActiveRecord::Schema.define(version: 2020_11_13_093925) do
  ...
  create_table "clocks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "stars", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_stars_on_article_id"
    t.index ["user_id", "article_id"], name: "index_stars_on_user_id_and_article_id", unique: true
